...
for index, value in enumerate(csv_reader.get_first_delivery()):
    ...
    csv_reader.get_first_delivery()[index][10] = "At Hub"  # Initialize status as "At Hub"
...
for index, value in enumerate(csv_reader.get_second_delivery()):
    ...
    csv_reader.get_second_delivery()[index][10] = "At Hub"  # Initialize status as "At Hub"
...
for index, value in enumerate(csv_reader.get_final_delivery()):
    ...
    csv_reader.get_final_delivery()[index][10] = "At Hub"  # Initialize status as "At Hub"
